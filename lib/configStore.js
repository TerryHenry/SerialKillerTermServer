...
const defaults = {
  ...
  web: {
    ...
    // Off by default -- the hostname is handed to an unauthenticated visitor (the whole
    // point is showing it before login, to help someone at a rack full of boxes confirm
    // they're on the right one), so this is an explicit opt-in rather than always on.
    showHostnameOnLogin: false
  },
...
function mergeWithDefaults(raw) {
  ...
  return {
    ...
    web: {
      ...
      showHostnameOnLogin: typeof rawWeb.showHostnameOnLogin === 'boolean' ? rawWeb.showHostnameOnLogin : defaults.web.showHostnameOnLogin
    },
