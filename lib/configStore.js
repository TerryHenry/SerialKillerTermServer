...
const defaults = {
  ...
  ups: {
    ...
    // shared secret, not a real username/password), identifier for powerman-pdu (the
    // PDU node name as known to the already-running powerman daemon). Persisted
    // regardless of driver so switching drivers and back doesn't lose what was typed.
    community: '',
    identifier: ''
  },
  tftp: {
